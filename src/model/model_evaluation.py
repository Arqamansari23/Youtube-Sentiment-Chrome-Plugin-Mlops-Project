...
def main():
    mlflow.set_tracking_uri("http://ec2-54-242-167-156.compute-1.amazonaws.com:5000/")
    ...
    with mlflow.start_run() as run:
        try:
            ...
            test_data = load_data(os.path.join(root_dir, 'data/Preprocessed_data/test_processed.csv'))

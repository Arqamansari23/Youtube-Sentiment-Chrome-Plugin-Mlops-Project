...
# Load the model and vectorizer from the model registry of Mlflow and local storage
# def load_model_and_vectorizer(model_name, model_version, vectorizer_path):
#     # Set MLflow tracking URI to your server
#     mlflow.set_tracking_uri("http://ec2-54-242-167-156.compute-1.amazonaws.com:5000/")  # Replace with your MLflow tracking URI
#     client = MlflowClient()
...
# load the model and tokanizer from local storage 
